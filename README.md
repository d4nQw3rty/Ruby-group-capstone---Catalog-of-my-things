...
**[Catalog-of-my-things]** is an application which allows the user to save items, whether they be books, games or music albums, and group them up by author, genre or label.
...
- **[Add new books, games or music albums, and see the ones previously added, and they are saved to JSON files.]**
- **[Create authors, genres and labels to sort the various items, also stored in JSON.]**
...
- Add the ability to delete categories, like genres or labels.
